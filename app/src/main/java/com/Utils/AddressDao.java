...
public class AddressDao {
    ...
    private static final String PATH="data/data/com.example.monkeyzzi.monkeymobilesafe/files/address.db";//注意该路径必须是这个目录，否则数据库访问不到
    private static String address;

    public static String getAdderss(String number){
        String address="unknown num";
